...
<html>
<head>
    <title>Tentang Kami - Coffee Company</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navTentang">
...
<div class="section-content bg-light mt-5">
    <div class="container">
        <h1 class="mb-4">Tentang Kami</h1>
        <p class="lead">Coffee Company adalah perusahaan kopi lokal yang berdedikasi menyajikan kopi terbaik dari petani Nusantara.</p>
    </div>
</div>
</body>
</html>
